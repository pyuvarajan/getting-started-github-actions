...
do
	...
	echo " [*] Last successful builds for \"${BRANCH}\":" >> kvsk_f1.json
	echo "     Broadcom: ${BUILD_BRCM}" >> kvsk_f1.json
	echo "     Mellanox: ${BUILD_MLNX}" >> kvsk_f1.json
	echo "     Virtual Switch: ${BUILD_VS}"  >> kvsk_f1.json
